        ...
        <div>
          ...
          <div className="overflow-hidden rounded-2xl bg-negro-fondo-acro border border-gris-claro-acro/20 shadow-xl">
            ...
            <div className="p-4 bg-negro-fondo-acro/80">
              ...
              <div className="grid grid-cols-7 gap-2 items-center relative pb-10">
        ...
        <div>
          ...
          <div className="overflow-hidden rounded-2xl bg-negro-fondo-acro border border-gris-claro-acro/20 shadow-xl">
            ...
            <div className="p-4 bg-negro-fondo-acro/80">
              ...
              <div className="grid grid-cols-5 gap-2 items-center relative pb-10">
                <div className="col-span-1">
                  <input
                    type="text"
                    value={promoNombre}
        ...
        <div>
          ...
          <div className="overflow-hidden rounded-2xl bg-negro-fondo-acro border border-gris-claro-acro/20 shadow-xl">
            ...
            <div className="p-4 bg-negro-fondo-acro/80">
              ...
              <div className="grid grid-cols-3 gap-2 items-center relative pb-10">
                <div className="col-span-1">
                  <select
